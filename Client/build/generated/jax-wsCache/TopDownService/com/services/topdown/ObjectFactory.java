 ...
 * generated in the com.services.topdown package. 
...
public class ObjectFactory {
    ...
    private final static QName _BookTicketResponse_QNAME = new QName("http://topdown.com.se/", "bookTicketResponse");
    private final static QName _IssueTicketResponse_QNAME = new QName("http://topdown.com.se/", "issueTicketResponse");
    private final static QName _UnauthorizedException_QNAME = new QName("http://topdown.com.se/", "UnauthorizedException");
    private final static QName _BookTicket_QNAME = new QName("http://topdown.com.se/", "bookTicket");
    private final static QName _IssueTicket_QNAME = new QName("http://topdown.com.se/", "issueTicket");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.services.topdown
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://topdown.com.se/", name = "bookTicketResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://topdown.com.se/", name = "issueTicketResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://topdown.com.se/", name = "UnauthorizedException")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://topdown.com.se/", name = "bookTicket")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://topdown.com.se/", name = "issueTicket")
